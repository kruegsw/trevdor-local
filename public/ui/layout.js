export function computeLayout({ width, height }) {
  ...
  return [
    // --- decks
    { uiID: "decks.tier1", kind: "decks.tier1", x: ROW_CARD_NOBLE_XY[0], y: TIER1_Y, w: CARD_WH.w, h: CARD_WH.h, statePath: ["decks", "tier1"] },
    { uiID: "decks.tier2", kind: "decks.tier2", x: ROW_CARD_NOBLE_XY[0], y: TIER2_Y, w: CARD_WH.w, h: CARD_WH.h, statePath: ["decks", "tier2"] },
    { uiID: "decks.tier3", kind: "decks.tier3", x: ROW_CARD_NOBLE_XY[0], y: TIER3_Y, w: CARD_WH.w, h: CARD_WH.h, statePath: ["decks", "tier3"] },

    // --- nobles
    { uiID: "market.nobles-1", kind: "noble", x: ROW_CARD_NOBLE_XY[0], y: BOARD_TOP_Y, w: NOBLE_WH.w, h: NOBLE_WH.h, statePath: ["market", "nobles", 0] },
    { uiID: "market.nobles-2", kind: "noble", x: ROW_CARD_NOBLE_XY[1], y: BOARD_TOP_Y, w: NOBLE_WH.w, h: NOBLE_WH.h, statePath: ["market", "nobles", 1] },
    { uiID: "market.nobles-3", kind: "noble", x: ROW_CARD_NOBLE_XY[2], y: BOARD_TOP_Y, w: NOBLE_WH.w, h: NOBLE_WH.h, statePath: ["market", "nobles", 2] },
    { uiID: "market.nobles-4", kind: "noble", x: ROW_CARD_NOBLE_XY[3], y: BOARD_TOP_Y, w: NOBLE_WH.w, h: NOBLE_WH.h, statePath: ["market", "nobles", 3] },
    { uiID: "market.nobles-5", kind: "noble", x: ROW_CARD_NOBLE_XY[4], y: BOARD_TOP_Y, w: NOBLE_WH.w, h: NOBLE_WH.h, statePath: ["market", "nobles", 4] },

    // --- tier 1
    { uiID: "market.cards.tier1-1", kind: "market.card", tier: 1, index: 0, x: ROW_CARD_NOBLE_XY[1], y: TIER1_Y, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier1", 0] },
    { uiID: "market.cards.tier1-2", kind: "market.card", tier: 1, index: 1, x: ROW_CARD_NOBLE_XY[2], y: TIER1_Y, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier1", 1] },
    { uiID: "market.cards.tier1-3", kind: "market.card", tier: 1, index: 2, x: ROW_CARD_NOBLE_XY[3], y: TIER1_Y, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier1", 2] },
    { uiID: "market.cards.tier1-4", kind: "market.card", tier: 1, index: 3, x: ROW_CARD_NOBLE_XY[4], y: TIER1_Y, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier1", 3] },

    // --- tier 2
    { uiID: "market.cards.tier2-1", kind: "market.card", tier: 2, index: 0, x: ROW_CARD_NOBLE_XY[1], y: TIER2_Y, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier2", 0] },
    { uiID: "market.cards.tier2-2", kind: "market.card", tier: 2, index: 1, x: ROW_CARD_NOBLE_XY[2], y: TIER2_Y, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier2", 1] },
    { uiID: "market.cards.tier2-3", kind: "market.card", tier: 2, index: 2, x: ROW_CARD_NOBLE_XY[3], y: TIER2_Y, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier2", 2] },
    { uiID: "market.cards.tier2-4", kind: "market.card", tier: 2, index: 3, x: ROW_CARD_NOBLE_XY[4], y: TIER2_Y, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier2", 3] },

    // --- tier 3
    { uiID: "market.cards.tier3-1", kind: "market.card", tier: 3, index: 0, x: ROW_CARD_NOBLE_XY[1], y: TIER3_Y, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier3", 0] },
    { uiID: "market.cards.tier3-2", kind: "market.card", tier: 3, index: 1, x: ROW_CARD_NOBLE_XY[2], y: TIER3_Y, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier3", 1] },
    { uiID: "market.cards.tier3-3", kind: "market.card", tier: 3, index: 2, x: ROW_CARD_NOBLE_XY[3], y: TIER3_Y, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier3", 2] },
    { uiID: "market.cards.tier3-4", kind: "market.card", tier: 3, index: 3, x: ROW_CARD_NOBLE_XY[4], y: TIER3_Y, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier3", 3] },

    // --- bank tokens
    { uiID: "bank.yellow", color: "yellow", kind: "token", x: MARGIN + GAP,                 y: BANK_TOKEN_Y, w: TOKEN_WH.w, h: TOKEN_WH.h, statePath: ["market", "bank", "yellow"] },
    { uiID: "bank.green",  color: "green",  kind: "token", x: MARGIN + GAP * 5 + TOKEN_WH.w, y: BANK_TOKEN_Y, w: TOKEN_WH.w, h: TOKEN_WH.h, statePath: ["market", "bank", "green"] },
    { uiID: "bank.red",    color: "red",    kind: "token", x: MARGIN + GAP * 6 + TOKEN_WH.w * 2, y: BANK_TOKEN_Y, w: TOKEN_WH.w, h: TOKEN_WH.h, statePath: ["market", "bank", "red"] },
    { uiID: "bank.blue",   color: "blue",   kind: "token", x: MARGIN + GAP * 7 + TOKEN_WH.w * 3, y: BANK_TOKEN_Y, w: TOKEN_WH.w, h: TOKEN_WH.h, statePath: ["market", "bank", "blue"] },
    { uiID: "bank.black",  color: "black",  kind: "token", x: MARGIN + GAP * 8 + TOKEN_WH.w * 4, y: BANK_TOKEN_Y, w: TOKEN_WH.w, h: TOKEN_WH.h, statePath: ["market", "bank", "black"] },
    { uiID: "bank.white",  color: "white",  kind: "token", x: MARGIN + GAP * 9 + TOKEN_WH.w * 5, y: BANK_TOKEN_Y, w: TOKEN_WH.w, h: TOKEN_WH.h, statePath: ["market", "bank", "white"] },
    ...
    { uiID: "player.cards.red", color: "red", kind: "fanned.cards", x: ROW_CARD_NOBLE_XY[1], y: PLAYER_PANEL.y + CARD_WH.w + GAP*2 + TOKEN_WH.h, w: CARD_WH.w, h: CARD_WH.h, statePath: ["players", 0, "cards"]},
