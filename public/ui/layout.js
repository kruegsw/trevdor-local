export function computeLayout(viewport = { width, height }, uiState) {
  ...
  const slots = [
    ...
    slotSP(0, { uiID: "summary.p0.gems.blue",  kind: "summary.gems", playerIndex: 0, color: "blue",  dx: COL1_X + CELL_W * 1, dy: GEMS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(0, { uiID: "summary.p0.gems.green", kind: "summary.gems", playerIndex: 0, color: "green", dx: COL1_X + CELL_W * 2, dy: GEMS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(0, { uiID: "summary.p0.gems.red",   kind: "summary.gems", playerIndex: 0, color: "red",   dx: COL1_X + CELL_W * 3, dy: GEMS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(0, { uiID: "summary.p0.gems.black", kind: "summary.gems", playerIndex: 0, color: "black", dx: COL1_X + CELL_W * 4, dy: GEMS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),

    // Tokens row (yellow alone at COL0_X; others align under gems)
    slotSP(0, { uiID: "summary.p0.tokens.yellow", kind: "summary.tokens", playerIndex: 0, color: "yellow", dx: COL0_X,                dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(0, { uiID: "summary.p0.tokens.white",  kind: "summary.tokens", playerIndex: 0, color: "white",  dx: COL1_X + CELL_W * 0, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(0, { uiID: "summary.p0.tokens.blue",   kind: "summary.tokens", playerIndex: 0, color: "blue",   dx: COL1_X + CELL_W * 1, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(0, { uiID: "summary.p0.tokens.green",  kind: "summary.tokens", playerIndex: 0, color: "green",  dx: COL1_X + CELL_W * 2, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(0, { uiID: "summary.p0.tokens.red",    kind: "summary.tokens", playerIndex: 0, color: "red",    dx: COL1_X + CELL_W * 3, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(0, { uiID: "summary.p0.tokens.black",  kind: "summary.tokens", playerIndex: 0, color: "black",  dx: COL1_X + CELL_W * 4, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    ...
    slotSP(1, { uiID: "summary.p1.gems.green", kind: "summary.gems", playerIndex: 1, color: "green", dx: COL1_X + CELL_W * 2, dy: GEMS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(1, { uiID: "summary.p1.gems.red",   kind: "summary.gems", playerIndex: 1, color: "red",   dx: COL1_X + CELL_W * 3, dy: GEMS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(1, { uiID: "summary.p1.gems.black", kind: "summary.gems", playerIndex: 1, color: "black", dx: COL1_X + CELL_W * 4, dy: GEMS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),

    slotSP(1, { uiID: "summary.p1.tokens.yellow", kind: "summary.tokens", playerIndex: 1, color: "yellow", dx: COL0_X,                dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(1, { uiID: "summary.p1.tokens.white",  kind: "summary.tokens", playerIndex: 1, color: "white",  dx: COL1_X + CELL_W * 0, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(1, { uiID: "summary.p1.tokens.blue",   kind: "summary.tokens", playerIndex: 1, color: "blue",   dx: COL1_X + CELL_W * 1, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(1, { uiID: "summary.p1.tokens.green",  kind: "summary.tokens", playerIndex: 1, color: "green",  dx: COL1_X + CELL_W * 2, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(1, { uiID: "summary.p1.tokens.red",    kind: "summary.tokens", playerIndex: 1, color: "red",    dx: COL1_X + CELL_W * 3, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(1, { uiID: "summary.p1.tokens.black",  kind: "summary.tokens", playerIndex: 1, color: "black",  dx: COL1_X + CELL_W * 4, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    ...
    slotSP(2, { uiID: "summary.p2.gems.green", kind: "summary.gems", playerIndex: 2, color: "green", dx: COL1_X + CELL_W * 2, dy: GEMS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(2, { uiID: "summary.p2.gems.red",   kind: "summary.gems", playerIndex: 2, color: "red",   dx: COL1_X + CELL_W * 3, dy: GEMS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(2, { uiID: "summary.p2.gems.black", kind: "summary.gems", playerIndex: 2, color: "black", dx: COL1_X + CELL_W * 4, dy: GEMS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),

    slotSP(2, { uiID: "summary.p2.tokens.yellow", kind: "summary.tokens", playerIndex: 2, color: "yellow", dx: COL0_X,                dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(2, { uiID: "summary.p2.tokens.white",  kind: "summary.tokens", playerIndex: 2, color: "white",  dx: COL1_X + CELL_W * 0, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(2, { uiID: "summary.p2.tokens.blue",   kind: "summary.tokens", playerIndex: 2, color: "blue",   dx: COL1_X + CELL_W * 1, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(2, { uiID: "summary.p2.tokens.green",  kind: "summary.tokens", playerIndex: 2, color: "green",  dx: COL1_X + CELL_W * 2, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(2, { uiID: "summary.p2.tokens.red",    kind: "summary.tokens", playerIndex: 2, color: "red",    dx: COL1_X + CELL_W * 3, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(2, { uiID: "summary.p2.tokens.black",  kind: "summary.tokens", playerIndex: 2, color: "black",  dx: COL1_X + CELL_W * 4, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    ...
    slotSP(3, { uiID: "summary.p3.gems.green", kind: "summary.gems", playerIndex: 3, color: "green", dx: COL1_X + CELL_W * 2, dy: GEMS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(3, { uiID: "summary.p3.gems.red",   kind: "summary.gems", playerIndex: 3, color: "red",   dx: COL1_X + CELL_W * 3, dy: GEMS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(3, { uiID: "summary.p3.gems.black", kind: "summary.gems", playerIndex: 3, color: "black", dx: COL1_X + CELL_W * 4, dy: GEMS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),

    slotSP(3, { uiID: "summary.p3.tokens.yellow", kind: "summary.tokens", playerIndex: 3, color: "yellow", dx: COL0_X,                dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(3, { uiID: "summary.p3.tokens.white",  kind: "summary.tokens", playerIndex: 3, color: "white",  dx: COL1_X + CELL_W * 0, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(3, { uiID: "summary.p3.tokens.blue",   kind: "summary.tokens", playerIndex: 3, color: "blue",   dx: COL1_X + CELL_W * 1, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(3, { uiID: "summary.p3.tokens.green",  kind: "summary.tokens", playerIndex: 3, color: "green",  dx: COL1_X + CELL_W * 2, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(3, { uiID: "summary.p3.tokens.red",    kind: "summary.tokens", playerIndex: 3, color: "red",    dx: COL1_X + CELL_W * 3, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
    slotSP(3, { uiID: "summary.p3.tokens.black",  kind: "summary.tokens", playerIndex: 3, color: "black",  dx: COL1_X + CELL_W * 4, dy: TOKENS_Y, w: TOKEN_WH.w + GAP, h: TOKEN_WH.h, text: "0" }),
