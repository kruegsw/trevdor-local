export function computeLayout({ width, height }) {
  ...
  return [
    { id: "decks.tier1", kind: "decks.tier1", x: ROW_CARD_NOBLE_XY[0], y: MARGIN + NOBLE_WH.h + GAP, w: CARD_WH.w, h: CARD_WH.h },
    { id: "decks.tier2", kind: "decks.tier2", x: ROW_CARD_NOBLE_XY[0], y: MARGIN + NOBLE_WH.h + GAP*2 + CARD_WH.h, w: CARD_WH.w, h: CARD_WH.h },
    { id: "decks.tier3", kind: "decks.tier3", x: ROW_CARD_NOBLE_XY[0], y: MARGIN + NOBLE_WH.h + GAP*3 + CARD_WH.h*2, w: CARD_WH.w, h: CARD_WH.h },
    { id: "market.nobles-1", kind: "noble", x: ROW_CARD_NOBLE_XY[0], y: MARGIN, w: NOBLE_WH.w, h: NOBLE_WH.h, statePath: ["market", "nobles", 0] },
    { id: "market.nobles-2", kind: "noble", x: ROW_CARD_NOBLE_XY[1], y: MARGIN, w: NOBLE_WH.w, h: NOBLE_WH.h, statePath: ["market", "nobles", 1] },
    { id: "market.nobles-3", kind: "noble", x: ROW_CARD_NOBLE_XY[2], y: MARGIN, w: NOBLE_WH.w, h: NOBLE_WH.h, statePath: ["market", "nobles", 2] },
    { id: "market.nobles-4", kind: "noble", x: ROW_CARD_NOBLE_XY[3], y: MARGIN, w: NOBLE_WH.w, h: NOBLE_WH.h, statePath: ["market", "nobles", 3] },
    { id: "market.nobles-5", kind: "noble", x: ROW_CARD_NOBLE_XY[4], y: MARGIN, w: NOBLE_WH.w, h: NOBLE_WH.h, statePath: ["market", "nobles", 4] },
    { id: "market.cards.tier1-1", kind: "market.card", x: ROW_CARD_NOBLE_XY[1], y: MARGIN + NOBLE_WH.h + GAP, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier1", 0] },
    { id: "market.cards.tier1-2", kind: "market.card", x: ROW_CARD_NOBLE_XY[2], y: MARGIN + NOBLE_WH.h + GAP, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier1", 1] },
    { id: "market.cards.tier1-3", kind: "market.card", x: ROW_CARD_NOBLE_XY[3], y: MARGIN + NOBLE_WH.h + GAP, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier1", 2] },
    { id: "market.cards.tier1-4", kind: "market.card", x: ROW_CARD_NOBLE_XY[4], y: MARGIN + NOBLE_WH.h + GAP, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier1", 3] },
    { id: "market.cards.tier2-1", kind: "market.card", x: ROW_CARD_NOBLE_XY[1], y: MARGIN + NOBLE_WH.h + GAP*2 + CARD_WH.h, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier2", 0] },
    { id: "market.cards.tier2-2", kind: "market.card", x: ROW_CARD_NOBLE_XY[2], y: MARGIN + NOBLE_WH.h + GAP*2 + CARD_WH.h, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier2", 1] },
    { id: "market.cards.tier2-3", kind: "market.card", x: ROW_CARD_NOBLE_XY[3], y: MARGIN + NOBLE_WH.h + GAP*2 + CARD_WH.h, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier2", 2] },
    { id: "market.cards.tier2-4", kind: "market.card", x: ROW_CARD_NOBLE_XY[4], y: MARGIN + NOBLE_WH.h + GAP*2 + CARD_WH.h, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier2", 3] },
    { id: "market.cards.tier3-1", kind: "market.card", x: ROW_CARD_NOBLE_XY[1], y: MARGIN + NOBLE_WH.h + GAP*3 + CARD_WH.h*2, w: CARD_WH.w, h: CARD_WH.h, statePath: ["market", "cards", "tier3", 0] },
    ...
    { id: "bank.yellow", kind: "token", x: MARGIN + GAP, y: BANK_TOKEN_Y, w: TOKEN_WH.w, h: TOKEN_WH.h, statePath: ["market", "bank", "yellow"] },
    { id: "bank.green", kind: "token", x: MARGIN + GAP*5 + TOKEN_WH.w, y: BANK_TOKEN_Y, w: TOKEN_WH.w, h: TOKEN_WH.h, statePath: ["market", "bank", "green"] },
    { id: "bank.red", kind: "token", x: MARGIN + GAP*6 + TOKEN_WH.w*2, y: BANK_TOKEN_Y, w: TOKEN_WH.w, h: TOKEN_WH.h, statePath: ["market", "bank", "red"] },
    { id: "bank.blue", kind: "token", x: MARGIN + GAP*7 + TOKEN_WH.w*3, y: BANK_TOKEN_Y, w: TOKEN_WH.w, h: TOKEN_WH.h, statePath: ["market", "bank", "blue"] },
    { id: "bank.black", kind: "token", x: MARGIN + GAP*8 + TOKEN_WH.w*4, y: BANK_TOKEN_Y, w: TOKEN_WH.w, h: TOKEN_WH.h, statePath: ["market", "bank", "black"] },
    { id: "bank.white", kind: "token", x: MARGIN + GAP*9 + TOKEN_WH.w*5, y: BANK_TOKEN_Y, w: TOKEN_WH.w, h: TOKEN_WH.h, statePath: ["market", "bank", "white"] }
  ]
}
